...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'User'
        db.delete_table(u'rt_user_user')

        # Deleting model 'Group'
        db.delete_table(u'rt_user_group')

        # Removing M2M table for field members on 'Group'
        db.delete_table(db.shorten_name(u'rt_user_group_members'))
    ...
    models = {
        u'rt_user.group': {
            ...
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['rt_user.User']", 'symmetrical': 'False'}),
